...
/**
 * {@link LlmReviewService} backed by Spring AI's {@link ChatClient}.
 *
 ...
 */
@Service
public class SpringAiLlmReviewService implements LlmReviewService {

    private static final Logger log = LoggerFactory.getLogger(SpringAiLlmReviewService.class);
    ...
    public SpringAiLlmReviewService(ChatClient.Builder chatClientBuilder,
